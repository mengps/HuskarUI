...
imageType | int | HusEmpty.Image_Default | 预设的图片类型(来自 HusEmpty)
imageWidth | int | - | 图片宽度
imageHeight | int | - | 图片高度
description | string | '' | 描述文本
descriptionFont | font | - | 描述文本字体
descriptionPadding | int | 12 | 描述文本与图像的间距
colorText | color | - | 描述文本颜色
                ...
                Column {
                    ...
                    HusRadioBlock {
                        ...
                        model: [
                            ...
                            { label: 'Simple', value: HusEmpty.Image_Simple }
                        ]
                    }
                    ...
                    Rectangle {
                        ...
                        HusEmpty {
                            imageType: imageTypeRadio.currentCheckedValue
                            description: '暂无数据'
                            width: parent.width
