...
Item {
    ...
    property int type: DelSwitchEffect.Type_None
    ...
    Loader {
        active: control.type === DelSwitchEffect.Type_Opacity
        anchors.fill: parent
    ...
    Loader {
        active: control.type === DelSwitchEffect.Type_Blurry
        anchors.fill: parent
        sourceComponent: Item {
            MultiEffect {
                source: control.fromItem
    ...
    Loader{
        active: control.type === DelSwitchEffect.Type_Mask
        anchors.fill: parent
        sourceComponent: Item {
            Item {
                id: mask
    ...
    Loader {
        active: control.type === DelSwitchEffect.Type_Blinds
        anchors.fill: parent
        sourceComponent: Item {
            Item {
                id: blindsMask
                ...
                Image {
                    ...
                    source: control.maskSource || 'qrc:/DelegateUI/images/hblinds.png'
                    scale: control.maskScaleEnabled ? control.maskScale : 1
                    rotation: control.maskRotationEnabled ? control.maskRotation : 0
                    smooth: false
                }
    ...
    Loader {
        active: control.type === DelSwitchEffect.Type_3DFlip
        anchors.fill: parent
        sourceComponent: Item {
            MultiEffect {
                ...
                maskEnabled: true
                maskSource: Image {
                    source: control.maskSource || 'qrc:/DelegateUI/images/smoke.png'
                    visible: false
                }
    ...
    Loader {
        active: control.type === DelSwitchEffect.Type_Thunder
        anchors.fill: parent
        sourceComponent: Item {
            ...
            Image {
                id: thunderMask
                source: control.maskSource || 'qrc:/DelegateUI/images/stripes.png'
                scale: control.maskScaleEnabled ? control.maskScale : 1
                rotation: control.maskRotationEnabled ? control.maskRotation : 0
                visible: false
            }
